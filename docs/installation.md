...
By default, Narziss also shows one curated work meme beside the floating star every 20 minutes and hides it after 12 seconds. Use the menu bar to show one immediately or disable the reminders. Only the selected image is loaded from ChineseBQB and cached locally; the full repository is never downloaded.
