...
The content script validates and stores this state per origin and chat path, then removes the marker from the rendered page. Invalid or missing markers are ignored and the last valid state is retained.
